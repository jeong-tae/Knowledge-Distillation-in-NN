...
def run_train(args):
    ...
    checkpointer = Checkpointer(model, optimizer, scheduler, args.experiment, args.checkpoint_period)
...
def main():
    ...
    shutil.copy2('./train_teacher.sh', args.experiment+'/train_teacher.sh')
